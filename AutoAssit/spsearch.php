...
<html>
    ...
    <script type="text/javascript">
        function getStates(value) {
            $.post("sp_php.php", {PassSearch: value}, function (data) {
                $("#results").html(data);
            });
        }
    </script>
...
<div class="allcontain">
    <div class="feturedsection">
        <h1 class="text-center"><b><span class="bdots">&bullet;</span> <span class="carstxt">Sparepart Centers</span>&bullet;</b></h1>
    </div>
        ...
        <div class="row content">
            ...
            <div class="col-sm-8 text-left"> 
                    ...
                    <div class="form-group row">
                        <div class="col-8">
                            <input class="form-control col-md-12" onkeyup="getStates(this.value)" type="text" id="search" placeholder="Search Spare Part Center" name="search">
