...
<html>
    <head>
        ...
        <title>Service Center Request Approval</title>
        <style>
                    body {
   /* just for this demo. */
...
<div class="panel panel-default text-center">
                            <div class="panel-body" style="background-color:#d3c1ff;">
                                <p contenteditable="true"> 
                                     <h1 align='center'><span class="badge badge-secondary">Service Center Request Approval</span></h1>
<!--                                <h1 align='center' style="color:darkred;"><b>Garaj Details</b></h1></p>
       ...
       echo'<div class="container">';
            ...
            while ($row = mysqli_fetch_array($result)) {
                echo'  <tr>';
                echo '<form action="sc_accept_reject.php"method="post">';
