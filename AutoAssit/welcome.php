...
<!--				<button type="button" class="navbar-toggle collapsed toggle-costume" data-toggle="collapse" data-target="#upmenu" aria-expanded="false">
			...
			<li>
                                <a href="appointmentFrom.php">APPOINMENTS</a>
				...
				<li>
                                    <a href="sparepart_search.php">SPARE PARTS</a>
 
				</li>
                                <li>
                                    <a href="location_finder.php">Map</a>
 
				</li>
				<li>
                                    <a href="emil2.php">CONTACT US</a>
...
<!-- ________________________LATEST Parts _______________________-->
<div class="latestcars">
	<h1 class="text-center"><b>&bullet; NEW ARRIVALS &bullet;</b></h1>
...
$query="SELECT * FROM sparepart WHERE date > NOW()-INTERVAL 30 DAY";
	...
	<div class="grid">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				...
				<div class="txthover">
					<?php 
                                        echo '   <img src="'.$row["img_url"].'" alt="parts" height="300" width="600">  ';
                                        ?>
						<div class="txtcontent">
							...
							<div class="simpletxt">
								<?php echo '<h3 class="name">'.$row['name'].'</h3>';?>
								<?php echo '<p>'.$row['discription'].'</p>';?>
	 							
	 							<?php echo '<h4 class="price"> <span>Rs.</span>'.$row['unitprice'].'</h4>';?>
                                                           <?php echo"<a href='sparepartdescription.php?sp_id=$row[sp_id]'><b> <button>BUY NOW</button></b></a>";?>
