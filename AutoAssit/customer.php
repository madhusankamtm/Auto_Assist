...
<div class="allcontain">
    <div class="feturedsection">
        <h1 class="text-center"><b><span class="bdots">&bullet;</span> <span class="carstxt">CUSTOMERS</span>&bullet;</b></h1>
    </div>
        ...
        <div class="row content">
            ...
            <div class="col-sm-8 text-left"> 
                    ...
                    <div class="form-group row">
                        <div class="col-8">
                            <input class="form-control col-md-12" onkeyup="getStates(this.value)" type="text" id="search" placeholder="Search Customer" name="search">
