...
//            $spcid=$_SESSION["id"];
//            // $query = "SELECT * FROM `sparepart` WHERE name LIKE '%" . $valueToSearch . "%'";
//            $query = "SELECT * FROM `sparepart` WHERE spc_id =$_SESSION[id]";
...
//                $type = $_POST['vtype'];
//                $quntity = $_POST["qnty"];
//                $query1 = "INSERT INTO sp_order values(NULL,'".$_SESSION['id']."','madhusankamtm@gmail.com','" . $spname . "','" . $type . "','" . $quntity . "')";
...
<!--                    <h4>Sparepart Search</h4>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php while ($row = mysqli_fetch_array($search_result)): ?>
                          <form class="navbar-form"  action="#" method="post" role="search" class="center-block" >
                            <tr>
                                <td> <?php {
