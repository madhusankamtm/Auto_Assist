...
<html>
    <head>
        ...
        <title>Sparepart Center Request Approval</title>
...
<div class="panel panel-default text-center">
                            <div class="panel-body" style="background-color:#d3c1ff;">
                                <p contenteditable="true"> 
                                     <h1 align='center'><span class="badge badge-secondary">Sparepart Center Request Approval</span></h1>
                            </div>
                        </div>
       ...
       echo'<div class="container">';
            ...
            while ($row = mysqli_fetch_array($result)) {
                echo'  <tr>';
                echo '<form action="spc_accept_reject.php"method="post">';
