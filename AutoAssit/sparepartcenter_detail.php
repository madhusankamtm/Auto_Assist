...
<html lang="en">
    <head>
        <title>Sparepart Center Details</title>
...
<div class="panel panel-default text-center">
                            <div class="panel-body" style="background-color:#d3c1ff;">
                                ...
                                <h1 align='center' style="color:darkred;"><b>Sparepart Center Details</b></h1></p>
                                <h4 style="color:blue;"><b>Registered Sparepart Centers in Auto Assist Company </b></h4>
                            </div>
                        </div>
        <div class="container">
<a href="admin.php"><button type="button" class="btn btn-primary btn-arrow-left"><b>BACK</b></button></a>
                ...
                $result = mysqli_query($conn, "SELECT * FROM `detail` INNER JOIN user on detail.nic=user.user_id WHERE active=1 AND detail.nic in (SELECT nic FROM section WHERE section.section='Sparepart_center')");
        
               
                    while ($row = mysqli_fetch_array($result)){ 
                    echo' <tr class="info">';
                    echo " <form action=\"spc_detail_update.php\" method=\"post\">";
